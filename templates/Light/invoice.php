				...
				<td class="product">
					...
					<ul class="meta">
						...
						<?php if( !empty( $item['sku'] ) ) : ?>
							<li class="sku">
								<strong class="sku-label"><?php _e( 'SKU:', 'woocommerce-pdf-invoices-packing-slips' ); ?></strong> <?php echo $item['sku']; ?>
							</li>
						<?php endif; ?>
						<?php if( !empty( $item['weight'] ) ) : ?>
							<li class="weight">
								<strong class="weight-label"><?php _e( 'Weight:', 'woocommerce-pdf-invoices-packing-slips' ); ?></strong> <?php echo $item['weight']; ?><?php echo get_option('woocommerce_weight_unit'); ?>
							</li>
						<?php endif; ?>
					</ul>
...
<?php do_action( 'wpo_wcpdf_after_notes_totals', $this->type, $this->order ); ?>
