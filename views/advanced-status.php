			...
			<td colspan="3">
				<?php
					printf(
						...
						'<code>' . wpo_wcpdf_escape_image_file( WPO_WCPDF()->main->get_tmp_path() ) . '</code>', // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						'<code>' . wpo_wcpdf_escape_image_file( $upload_base ) . '</code>', // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						'<code>UPLOADS</code>',
			...
			<td colspan="3">
				<?php
					printf(
						...
						'<code>' . wpo_wcpdf_escape_image_file( WPO_WCPDF()->plugin_path() . '/vendor/dompdf/dompdf/lib/fonts/' ) . '</code>' // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					);
				?>
			</td>
		</tr>
