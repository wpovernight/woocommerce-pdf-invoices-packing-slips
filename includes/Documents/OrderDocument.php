...
abstract class OrderDocument {
	...
	*/
	...
	public function footer() {
		echo wp_kses_post( $this->get_footer() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
	...
	public function extra_1() {
		echo wp_kses_post( $this->get_extra_1() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
	...
	public function extra_2() {
		echo wp_kses_post( $this->get_extra_2() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
	...
	public function extra_3() {
		echo wp_kses_post( $this->get_extra_3() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
