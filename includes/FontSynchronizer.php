...
if (!class_exists('\WPO\IPS\FontSynchronizer')) {
    class FontSynchronizer
    {
        ...
        public function get_local_fonts(string $path): array
        {
            ...
            $legacy_cache_file = trailingslashit($path) . 'dompdf_font_family_cache.php';
            // Dompdf <2.0
