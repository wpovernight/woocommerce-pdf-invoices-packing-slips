		...
		$settings_fields = array(
			...
			array(
				...
				'args'		=> array(
					...
					'id'			=> 'header_logo_height',
					'size'			=> '5',
					'description'	=> __( 'Enter the total height of the logo in mm, cm or in and use a dot for decimals.<br/>For example: 1.15in or 30mm', 'woocommerce-pdf-invoices-packing-slips' )
				)
			),
			array(
				'type'		=> 'setting',
