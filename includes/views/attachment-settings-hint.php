...
<div class="wcpdf-attachment-settings-hint notice inline">
	<p>
		...
		<?php printf( '<a href="%s" style="display:block; margin-top:10px;">%s</a>', esc_url( wp_nonce_url( add_query_arg( 'wpo_wcpdf_hide_attachments_hint', 'true' )  ), esc_html__( 'Hide this message', 'woocommerce-pdf-invoices-packing-slips' ) ) ); ?>
	</p>
</div>
