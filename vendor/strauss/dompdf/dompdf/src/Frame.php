...
class Frame
{
     ...
     */
    public function set_decorator(\WPO\IPS\Vendor\Dompdf\FrameDecorator\AbstractFrameDecorator $decorator)
    {
    ...
    public function __toString()
    {
        ...
        if ($this->_decorator instanceof \WPO\IPS\Vendor\Dompdf\FrameDecorator\Block) {
            $str .= "Lines:<pre>";
            foreach ($this->_decorator->get_line_boxes() as $line) {
                foreach ($line->get_frames() as $frame) {
                    if ($frame instanceof \WPO\IPS\Vendor\Dompdf\FrameDecorator\Text) {
                        $str .= "\ntext: ";
